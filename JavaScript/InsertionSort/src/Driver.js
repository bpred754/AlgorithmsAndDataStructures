  ...
  extractBooks("../googleBooks100.txt", function(_books100) {
    ...
    InsertionSort.byAuthor(_books100);
    //InsertionSort.byNumberPages(_books100);
    //InsertionSort.byTitle(_books100);
    ...
    extractBooks("../googleBooks1000.txt", function(_books1000) {
      ...
      InsertionSort.byAuthor(_books1000);
      //InsertionSort.byNumberPages(_books1000);
      //InsertionSort.byTitle(_books1000);
      ...
      extractBooks("../googleBooks10000.txt", function(_books10000) {
        ...
        InsertionSort.byAuthor(_books10000);
        //InsertionSort.byNumberPages(_books10000);
        //InsertionSort.byTitle(_books10000);
